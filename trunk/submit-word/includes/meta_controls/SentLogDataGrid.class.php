<?php
	require(__META_CONTROLS_GEN__ . '/SentLogDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the SentLog class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of SentLog
	 ...
	 * 
	 */
	class SentLogDataGrid extends SentLogDataGridGen {
	}
?>